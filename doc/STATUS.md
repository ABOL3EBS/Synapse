...
| Helper daemon | `crates/platform-macos/src/helper/main.rs` | 385 | BPF raw ioctls, SCM_RIGHTS fd handoff, pf anchor init, enforcement loop, cache-push thread (5s interval). Socket permissions 0660. |
